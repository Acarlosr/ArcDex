...
export const BRIDGE_SOURCE_CHAINS: BridgeChainInfo[] = [
  { id: 11_155_111, bridgeChain: "Ethereum_Sepolia",   name: "Ethereum Sepolia", shortName: "Ethereum",  logo: "🔷", cctpDomain: 0,  usdc: "0x1c7D4B196Cb0C7B01d743Fbc6116a902379C7238", rpc: "https://ethereum-sepolia-rpc.publicnode.com" },
  { id: 84_532,     bridgeChain: "Base_Sepolia",        name: "Base Sepolia",     shortName: "Base",      logo: "🔵", cctpDomain: 6,  usdc: "0x036CbD53842c5426634e7929541eC2318f3dCF7e", rpc: "https://sepolia.base.org" },
  { id: 421_614,    bridgeChain: "Arbitrum_Sepolia",    name: "Arbitrum Sepolia", shortName: "Arbitrum",  logo: "🔺", cctpDomain: 3,  usdc: "0x75faf114eafb1BDbe2F0316DF893fd58CE46AA4d", rpc: "https://sepolia-rollup.arbitrum.io/rpc" },
  { id: 11_155_420, bridgeChain: "Optimism_Sepolia",    name: "OP Sepolia",       shortName: "Optimism",  logo: "🔴", cctpDomain: 2,  usdc: "0x5fd84259d66Cd46123540766Be93DFE6D43130D7", rpc: "https://sepolia.optimism.io" },
  { id: 80_002,     bridgeChain: "Polygon_Amoy_Testnet",name: "Polygon Amoy",     shortName: "Polygon",   logo: "🟣", cctpDomain: 7,  usdc: "0x41e94eb019c0762f9bfcf9fb1e58725bfb0e7582", rpc: "https://rpc-amoy.polygon.technology" },
  { id: 43_113,     bridgeChain: "Avalanche_Fuji",      name: "Avalanche Fuji",   shortName: "Avalanche", logo: "🔻", cctpDomain: 1,  usdc: "0x5425890298aed601595a70ab815c96711a31bc65", rpc: "https://api.avax-test.network/ext/bc/C/rpc" },
  ...
  { id: 4_801,      bridgeChain: "World_Chain_Sepolia", name: "World Chain Sepolia", shortName: "World", logo: "🌐", cctpDomain: 14, usdc: "0x66145f38cBAC35Ca6F1Dfb4914dF98F1614aeA88", rpc: "https://worldchain-sepolia.drpc.org" },
...
/** chainId -> { usdc, rpc } for balance reads */
export const BRIDGE_USDC_BY_CHAIN: Record<number, { usdc: `0x${string}`; rpc: string }> =
  Object.fromEntries(ALL_BRIDGE_CHAINS.map((c) => [c.id, { usdc: c.usdc, rpc: c.rpc }]))
