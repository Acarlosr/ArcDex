...
function ContractCard({ name, address, description }: ContractCardProps) {
    ...
    return (
        <div className="card-professional p-4">
            ...
            <code className="text-xs text-primary font-mono bg-primary/10 px-2 py-1 rounded block truncate">
                {address}
            </code>
        </div>
    )
            ...
            <div className="max-w-4xl mx-auto px-4 py-12">
                ...
                <div className="mb-8 bg-amber-500/10 border border-amber-500/30 rounded-lg p-4">
                    <div className="flex items-start gap-3">
                        ...
                        <div>
                            <h3 className="font-semibold text-amber-700 dark:text-amber-300 mb-1">Testnet Status</h3>
                ...
                <section className="mb-8">
                    ...
                    <div className="grid gap-3 md:grid-cols-2">
                        <a
                            ...
                            target="_blank"
                            rel="noreferrer"
                            className="flex items-center gap-2 p-3 rounded-lg bg-card hover:bg-muted border border-border hover:border-primary/30 transition-all"
                        >
                            <ExternalLink className="w-4 h-4 text-primary" />
