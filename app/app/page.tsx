      ...
      <div className="max-w-6xl mx-auto px-4 py-12">
        ...
        <div className="mb-6 bg-amber-500/10 border border-amber-500/30 rounded-lg p-3 flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <span className="text-amber-600 dark:text-amber-400 text-sm">You are using Arc Network Testnet. All data is for testing purposes only.</span>
          </div>
          <button
            onClick={() => setShowOnboarding(true)}
            className="text-amber-600 dark:text-amber-400 text-sm font-medium hover:text-amber-700 dark:hover:text-amber-300 flex items-center gap-1"
          >
        ...
        <div className="mb-8 flex flex-col md:flex-row md:items-center md:justify-between gap-4">
          <div>
            ...
            <p className="text-xl text-muted-foreground mb-2">The most advanced DeFi platform on Arc Network</p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-6 mb-12">
          <Link href="/app/stake" className="group">
            <div className="card-professional p-6 h-full">
        ...
        <div>
          <div className="flex items-center gap-2 mb-4">
            ...
            <span className="px-2 py-0.5 bg-muted text-muted-foreground text-xs font-medium rounded">DEMO DATA</span>
          </div>
