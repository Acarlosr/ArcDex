      ...
      <nav className="sticky top-0 z-50 bg-background/95 backdrop-blur-lg border-b border-border">
        <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            ...
            <span className="text-sm text-muted-foreground font-medium hidden sm:inline">Arc Testnet</span>

            {isConnected && address ? (
              <Button onClick={() => setIsDialogOpen(true)} variant="outline" className="border-primary/30 text-foreground hover:bg-muted">
          ...
          {isConnected && address ? (
            ...
            <div className="space-y-4">
              ...
              <button
                ...
                className="w-full p-4 rounded-xl bg-gradient-to-r from-primary/20 to-primary/10 hover:from-primary/30 hover:to-primary/20 text-foreground text-sm font-medium transition-all border border-primary/30 flex items-center gap-3"
              >
